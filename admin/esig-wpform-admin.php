...
if (!class_exists('ESIG_WPFORM_Admin')) :
    ...
    class ESIG_WPFORM_Admin extends ESIG_WPFORM_SETTING {
        ...
        public function esig_wpform_process($fields,$entry, $form_data, $entry_id) {
            ...
            $signer_name = apply_filters( 'wpforms_process_smart_tags', $form_data['settings']['signer_name'], $form_data ,$fields, $entry_id);
            $signer_email = apply_filters( 'wpforms_process_smart_tags', $form_data['settings']['signer_email'], $form_data ,$fields, $entry_id);
            ...
            self::save_submission_value($document_id, $fields);
            ...
            self::esig_invite_document($document_id, $signer_email, $signer_name, $form_id,$entry_id, $signing_logic);
        ...
        public function render_shortcode_esigwpform($atts) {
            ...
            $wpform_value = self::generate_value($document_id, $form_id, $field_id);
        ...
        public function esig_wpform_fields() {
            ...
            $wpform_array = $wpform->form->get($form_id, array('content_only' => true));
